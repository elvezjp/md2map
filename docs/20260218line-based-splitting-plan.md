...
```json
[{"title": "...", "start_line": 42, "end_line": 55}, ...]
```
...
- `start_line` がセクション本文の開始行以上であること
- `end_line` がセクション本文の終了行以下であること
- 最初のグループの `start_line` がセクション本文の開始行と一致すること
- 最後のグループの `end_line` がセクション本文の終了行と一致すること
